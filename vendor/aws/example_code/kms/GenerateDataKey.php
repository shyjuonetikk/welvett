...
// snippet-end:[kms.php.generate_data_key.import]
...
//Create a KMSClient 
// snippet-start:[kms.php.generate_data_key.main]
...
// snippet-end:[kms.php.generate_data_key.main]
// snippet-end:[kms.php.generate_data_key.complete]
