 ...
 *
 */
class RouterminalsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'arrival_terminal_id' => ['type' => 'integer', 'length' => 33, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'departure_time' => '15:35:04',
            'arrival_time' => '15:35:04',
            'user_id' => 1,
            'modified' => '2019-01-22 15:35:04'
        ],
    ];
}
