...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'names' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'names' => ['type' => 'unique', 'columns' => ['names'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
