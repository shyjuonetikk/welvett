...
class PaymentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('customer_issues')
            ->allowEmpty('customer_issues');

        $validator
            ->scalar('talent_issues')
            ->allowEmpty('talent_issues');

        $validator
            ->scalar('released_by')
            ->allowEmpty('released_by');

        $validator
            ->scalar('deducted_amount')
            ->allowEmpty('deducted_amount');

        $validator
            ->scalar('released_amount')
            ->allowEmpty('released_amount');

        $validator
            ->integer('released_from')
            ->allowEmpty('released_from');

        $validator
            ->integer('released_to')
            ->allowEmpty('released_to');
