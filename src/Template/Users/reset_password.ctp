                                    ...
                                    <div class="auth-form-light text-left p-5">
                                        ...
                                        <form method="post" class="pt-4">   
                                            <div class="input-group mb-3">
                                                ...
                                                <input style="" name="new_password" type="password" class="form-control verify" id="" placeholder="New Password">

                                            </div>  
                                            <div class="input-group mb-3">

                                                <input style="" name="confirm_password" type="password" class="form-control verify" id="" placeholder="Confirm Password">

                                            </div>

                                            <div class="mt-5">
                                                <button id="customer_login_button" type="submit" class="btn btn-block btn-lg font-weight-medium">Reset Password</button>
                                            </div>
