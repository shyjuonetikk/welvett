                            ...
                            <div class="row">
                                <div class="col-lg-6 bg-white mx-auto">
                                    <div class="auth-form-light text-left p-5">
                                        ...
                                        <h2 class="text-center">Verification Area</h2>
                                        
                                        <?= $this->Flash->render() ?>


                                        <form method="post" class="pt-4">                                         <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span style="border-color: rgba(0, 0, 0, 0.2);" class="input-group-text">W-</span>
                                            </div>
                                            <input style="border-left: none;" name="verify" type="text" class="form-control verify" id="exampleInputEmail1" placeholder="Verification code">
                                            </div>  
                                            
                                            <div class="mt-5">
                                                <button id="customer_login_button" type="submit" class="btn btn-block btn-lg font-weight-medium">Verify</button>
                                            </div>
