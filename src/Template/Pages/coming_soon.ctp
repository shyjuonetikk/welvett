        ...
        <nav class="navbar navbar-expand-lg navbar-light custom-navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $this->request->webroot;?>pages/comingSoon">About</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $this->request->webroot;?>pages/comingSoon">FAQs</a>
                    </li>
                        ...
                        <div id="nav_menu-4" class="boxr boxr_nav_menu">
                            ...
                            <div class="menu-customtemp-footer-container">
                                <ul id="menu-customtemp-main-2" class="customtemp-mobile-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo $this->request->webroot; ?>pages/comingSoon">About Us</a>
                                    </li>
                                    <li>
                                        <a  href="<?php echo $this->request->webroot; ?>pages/comingSoon">FAQ</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $this->request->webroot; ?>pages/comingSoon">Welvett for IOS (coming soon)</a>
                                    </li>
                                    <li>
                                        <a  href="<?php echo $this->request->webroot; ?>pages/comingSoon">Welvett for Android (coming soon)</a>
                                    </li>
