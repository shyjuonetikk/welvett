...
<div class="container-fluid content-section">
    ...
    $conn = ConnectionManager::get('default');
                ?>
                <div id="hom<?php echo $k; ?>"  class="container tab-pane <?php if ($i == 0) echo 'active'; ?> <?php if ($i != 0) echo 'fade'; ?>"><br>
                    <div class="row">
                        <?php foreach ($event_employees as $event_employee):
    ...
    $calculateRatings = 0;
    if (isset($ratings[0])) {
        $calculateRatings = $ratings[0]['ratings'] / $ratings[0]['total_booking'];
    }
                        ?>
                        <?php
    if ($events['title'] == $event_employee['sub']) {
            ...
            $path = $this->request->webroot.'img/users/"'.$image.'"';
                        ...
                        <div class="li-setting col-sm-6 col-md-6 col-lg-3" style="height: 50%">
                            <a href="<?php echo $this->request->webroot . 'EmployeeMembers/view_employee/' . $event_employee['event_id']; ?>">
                                ...
                                <div id='profile_image_div' class="profile_image" style="display: inline-block;width:130px;background-position: center;background-size:cover;background-image: url('<?php echo $path; ?>'); float: left;"></div>
        ...
        //echo $event_employee['review'];
                    ...
                    <div class="col-sm-12 text-center">
                        <span style="color:#efefef !important; font-size: 40px;">Sorry No Record Found</span>
                    </div>
                    <?php }
                    ?>
                </div>
        ...
        $imageicon = 'cyber1550500683.png';
                            ...
                            <div>
                                <span class="category_icon_block" style="">
                                    ...
                                    <img style="" src="<?php echo $this->request->webroot; ?>img/event/<?php echo $imageicon ?>" class="caticon-image cat_icons" alt="">

                                    <span class="profile_font_color"><?= $calculateRatings; ?>/5 <i class="fa fa-star gotted_stars" style=""></i></span>
                                </span>
                            </div>
