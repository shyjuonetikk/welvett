    ...
    <div class="container">
        <div class="row" id="profile_header">
            <div class="col-md-5 col-lg-5 pos_relative">
                <h1 class="profile_text_color pos_absolute">Corporate Member</h1>
            </div>
            <div class="col-md-2 col-lg-2 text-center">
                ...
                <div>
                    ...
                    <span class="profile_text_color">
                        <?php
                        if ($user->state != null) {
                            echo $user->city . ', ' . $states[$user->state];
                        } else {
                            ?>
                            &nbsp;&nbsp;&nbsp;
                            <?php
            ...
            <div class="col-md-5 col-lg-5 pos_relative">
                <div class="pos_absolute" style="right: 10%;">
                    <div class="btn_in_header">
                        <a href="<?php echo $this->request->webroot; ?>corporateMembers/corporateReviews" class="review_link">
...
<section class="content-wrapper content_bg">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <form id="dashboard_service">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 text-left">
                                <input id="first_name" name="first_name" type="text" class="" readonly value="<?php echo $user->first_name; ?>">
                            </div>
                            <div class="col-md-6 col-lg-6 text-right">
                                <span style="position: relative;">
                                    <?php
                            ...
                            <div class="col-md-6 col-lg-6 text-left">
                                <input id="last_name" name="last_name" type="text" class="" readonly value="<?php echo $user->last_name; ?>">
                            </div>
                        ...
                        <div class="row">
                            ...
                            if ($loginWithSocial == 'undefined' || $loginWithSocial == '') {
                                ...
                                <div class="col-md-6 col-lg-6 text-left">
                                    <input id="password" name="password" type="password" class="" readonly value="">
                                ...
                                <div class="col-md-6 col-lg-6 text-left">
                                    <input id="confirm_password" name="confirm_password" type="password" class="" readonly value="">
                            ...
                            <div class="col-md-6 col-lg-6 text-left">
                                <input id="phone1" name="phone1" type="text" class="" readonly value="<?php echo $user->phone1; ?>">
                            </div>
            ...
            <div class="col-md-8 col-lg-8" style="padding-right:25px;">
                <div id="my_events">
                    <div>
                        <div>
                            <h4 class="text-center" style="margin-bottom: 1rem;"><i class="fa fa-calendar"></i> My Events</h4>
                        </div>
                            ...
                            foreach ($bookings as $booking):
                                ...
                                <div class="row" id="bookingNumber<?= $booking->id; ?>">
                                    <div class="col-lg-7 event_detail">
                                        ...
                                        if ($booking->status == 2) {
                                            if ($booking->payment->customer_issues) {
                                                ...
                                                if ($booking->payment->dispute_resolved) {
                                                    ...
                                                    ?>
                                                    <span class="pull-right <?=$disputeBadge?>" onclick="bothDisputes(<?= $booking->payment->id ?>)" style="cursor: pointer;margin:0 5px;"><?= $dispLabel; ?></span>
                                        ...
                                        ?>
                                        <a href="<?php echo $this->request->webroot . 'CorporateMembers/messages/' . $booking->id ?>"  data-toggle="tooltip" title="Discuss" class="event_button pull-right discuss_button" style="margin:0 5px;cursor: pointer;"><i class="fa fa-comments"></i></a>
...
<script>
    function dispute(payment_id) {
        $.ajax({
            ...
            {
                if (data != '') {
                    $('#opponentDispute').html('<label class="col-md-12">Talent Disputed</label><div class="col-md-12"><p class="custom_field">' + data + '</p></div>')
                }
...
<script>
    function submit_review(review) {
        if ($('#rating_div' + review).length == 1) {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo $this->request->webroot . 'CorporateMembers/add_review' ?>',
...
<script>
    ...
    function validate_booking() {
        ...
        if ($('#from_date').val() && $('#to_date').val()) {
            $.ajax({
                ...
                data: 'from_date=' + $('#from_date').val() + '&to_date=' + $('#to_date').val() + '&talent=' +<?= $booking->talent_id; ?> + '&event_type=' + event_type,
                success: function (data)
                {
                    data = JSON.parse(data);
    ...
    $(document).ready(function (e) {
        ...
        $(document).on('click', '#requestBooking', function () {
            ...
            if (check == 0) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo $this->request->webroot ?>EmployeeMembers/validate_bookings',
                    data: 'from_date=' + $('#from_date').val() + '&to_date=' + $('#to_date').val() + '&talent=' +<?= $booking->talent_id; ?> + '&event_type=' + event_type + '&from_time=' + from_time + '&to_time=' + to_time,
                    success: function (data)
                    {
                        data = JSON.parse(data);
                        console.log(data);
        ...
        $(document).on('change', '#booking_form input[name=modal_event_type]', function () {
            validate_booking();
        });
