...
<div class="panel-head-info">
    <p class="pull-left info-text">Add Permission</p>
...
<div class="container content-container">
  ...
  <div class="form-group">
            <div class="col-md-12 text-center">
                <?php 
                echo $this->Form->control('Add Permissions',array('type'=>'submit','div'=>false,'label'=>false,'class'=>'btn btn-default btn-blue-custom btn-lg'));
                echo $this->Form->end(); ?>
            </div>
        </div>
    </div>
