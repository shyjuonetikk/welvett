...
<html lang="en">
    ...
    if ($roleId == 2) {
                    ...
                    ?>
                    <a class="navbar-brand" href="<?php echo $this->request->webroot; ?>EmployeeMembers/employee_events">
                        <img src="<?php echo $this->request->webroot ?>assets/images/logo.png" class="image-responsive mini-logo"  />
                    </a>
                    <?php
    }
                ...
                <ul class="nav navbar-nav navbar-right ml-auto">
                    <li class="nav-item dropdown notifydd">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-envelope"></i><span class="badge"><?= $messageCount; ?></span></a>
                                        ...
                                        <div class="row" style="margin:0;">
                                            <div class="col-md-3" style="padding: 5px !important;">
                                                <div class="notify-img">
                                                    <img src="<?php echo $this->request->webroot . 'img/users/' . $latest->user->profile_image ?>" alt="" style="width:100%;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1" style="padding: 0 !important;">
                                                <span class="badge badge-secondary"><?php // echo $single->talent_messages[0]->count;      ?></span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item dropdown notifydd">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-bell"></i><span class="badge"><?= count($notifications); ?></span></a>
                        <ul class="dropdown-menu notify-drop">
                            <div class="notify-drop-title">
                                <div class="row">
                            ...
                            <div class="drop-content">
                                ...
                                ?>
                                <li>
                                    <div class="col-md-9 pull-left" style="padding:0 0 0 5px;">
                                        <p><?= $n->message; ?></p>
                                    </div>
                                    <div class="col-md-3 pull-right" style="padding:0;">
                                        <p>
                                            <?php
                                            $time = new Time($n->created);
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a href="#" data-toggle="dropdown" class="nav-link  user-action">
                            <?php if (!empty($this->request->session()->read('Auth.User.loginwithsocial')) && $row['profile_image'] != 'undefined') { ?>
                            <img src="<?php echo $row['profile_image']; ?>" class="avatar" alt=""> 
                            <?php } else if (!empty($row['profile_image']) && $row['profile_image'] != 'undefined') { ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo $this->request->webroot ?>users/individual-events" class="dropdown-item"><i class=""></i> My events</a></li>
                            <li><a href="<?php echo $this->request->webroot ?>users/individualReviews" class="dropdown-item"><i class=""></i> My reviews</a></li>
                            <?php } ?>
                            <?php
                            if ($roleId == 3) {
                            ?>
                            ...
                            <li><a href="<?php echo $this->request->webroot ?>corporateMembers/corporateEvents" class="dropdown-item"><i class=""></i> My events</a></li>
                            <li><a href="<?php echo $this->request->webroot ?>corporateMembers/corporateReviews" class="dropdown-item"><i class=""></i> My review</a></li>
                            <?php
                            }
                            if ($roleId == 4) {
                            ?>
                            ...
                            <li><a href="<?php echo $this->request->webroot ?>EmployeeMembers/employee_events" class="dropdown-item"><i class=""></i> Bookings</a></li>
                            <li><a href="<?php echo $this->request->webroot ?>EmployeeMembers/talentReviews" class="dropdown-item"><i class=""></i> My reviews</a></li>
                            <?php
                                if ($membership) {
                            ?>
                            ...
                            success: function (data)
                            {
                                ...
                                } else
                                {
                                    ...
                                    $.each(data, function (key, value) {
                                        ...
                                        $('#search-result').empty();
                                        if (icon == null) {
                                            icon = 'cyber1550500683.png';

                                        }
                                        var app = "<ul>"
                                        + "<li class='searched_user'>"
                                        + "<img src='<?php echo $this->request->webroot ?>img/users/" + icon + "'  width='30' height: 30px class='avatar pull-left' />"
                            ...
                            success: function (data)
                            {
                                ...
                                } else
                                {
                                    ...
                                    $.each(data, function (key, value) {
                                        ...
                                        var app = "<ul>"
                                        + "<li class='searched_user'>"
                                        + "<img src='<?php echo $this->request->webroot ?>img/users/" + value.profile_image + "'  width='30' height: 30px class='avatar pull-left' />"
                                        + "<p class='pull-left left-10 get_value'>" + value.first_name + " " + value.last_name + "</p>"
                                        + "<img src='<?php echo $this->request->webroot ?>img/event/" + value.image_icon + "' width='30' class='pull-right icon-image' />"
                                        + "<div class='clearfix'></div>"
                                        + "</li>"
