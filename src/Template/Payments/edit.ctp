...
<div class="panel-head-info">
    <p class="pull-left info-text">Edit Payments</p>
...
<div class="container content-container">
    <div class="users form">
        ...
        <div class="form-group required">
            <label for="payment_type" class="col-md-2 control-label">Payment Type</label>
            <div class="col-md-6">
        ...
        <div class="form-group">
            <div class="col-md-12 text-center">
                <?php 
                echo $this->Form->control('Edit Payments',array('type'=>'submit','div'=>false,'label'=>false,'class'=>'btn btn-default btn-blue-custom btn-lg'));
                echo $this->Form->end(); ?>
            </div>
        </div>
    </div>
