...
<?php $userids = $this->request->session()->read('Auth.User.id');
//debug($events['id']);
?>
...
<section class="content-wrapper content_bg" style="padding-top: 35px;">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-lg-3 col-xl-3 border_right_me text-center credit_card_bank" >
                <div class="text-center" id="basic_info">
                    <div class="row" >
                        <div class="col-md-12 col-lg-12">
                            <div style="border-bottom: 2px solid #acacac; padding-bottom: 30px;">
            ...
            <div class="col-md-9 col-lg-9 col-xl-9" style=" height: 250px; background: #F5F5F5;   border-radius: 3px ;box-shadow: 2px 2px 2px 2px #dddd;">
                    ...
                    <div class="row" >
                        <div class="col-md-3 col-lg-3 text-center" >
                            <div class="">
                                ...
                                <div class="" style=" font-size: 14px; border-radius: 8px; background: #7b1b2d; color: #F5F5F5; width: 150px;height: 100px; margin-top: 10px;margin-left: 40px;">Earning in month</div>
                        ...
                        <div class="col-md-3 col-lg-3 text-center" >
                            <div style="">
                                <label class="text-center">Booking Price</label>
                                <div class="dashbord_text_color" style=" font-size: 14px; border-radius: 8px; background: #7b1b2d; color: #F5F5F5; width: 120px;height: 50px; margin-top: 10px;margin-left: 40px;">

                                    <div class="col-md-12" style="padding:0 border:0px;">
                                        <span class="input-group-btn">
                                            <button type="button" class="inc_dec btn-number" disabled="disabled" data-type="minus" data-field="quant[1]">
                                                <span class="fa fa-minus"></span>
                                            </button>
                                        </span>
                                        <input type="text" name="quant[1]" class="inc_dec_field input-number"  id="bookingamount" value="1" min="1" max="10000">
                                        <span class="input-group-btn">
                                            <button type="button" class="inc_dec btn-number" data-type="plus" data-field="quant[1]">
                                ...
                                <label for="event_type" >Hourly</label>
                                <input type="radio" value="Whole Event" name="event_type" id="event_type">
                                <label for="event_type">Whole Event</label>
                        ...
                        <div class="col-md-3 col-lg-3 text-center" >
                            <div style="">
                                ...
                                <div class="dashbord_text_color" style=" font-size: 20px;  color: #F5F5F5; margin-top: 10px;margin-left: 40px;"> <img src="<?php echo $this->request->webroot ?>img/stats.jpg" width="350"/></div>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-12 col-lg-12" style=" ">
                            <div style="margin-top: 10px;  ">
                                ...
                                <label style=" color:white; background:#7b1b2d;border-radius: 3px;  ">Upgrade to Pro</label>
                            </div>
