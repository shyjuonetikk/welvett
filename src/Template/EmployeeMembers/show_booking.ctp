...
<div class="row">
    ...
    <div class="col-md-5 calendar_view" style="padding: 0 25px;">
        ...
        <?php } else { ?>
            <h6 style="color:#711A2A;">My Schedule on the given dates</h6>
...
<?php
if ($booking->status == 3 || $booking->status == 0):
    ?>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="form-group" style="text-align:center">
                    <div class="row">
                        <div class="col-md-6" style="text-align: center;">
                            <button id="requestBooking" class="modal_btn decline_btn" name="decline" type="submit" style="border:none;">Decline</button>

                        </div>
                        <div class="col-md-6" style="text-align: center;">
                            <button class="modal_btn btn-success" name="accept" type="submit" style="border:none;">Accept</button>

                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="text-align: center;">
                            <a class="modal_btn btn-warning" href="<?= $this->request->webroot . 'EmployeeMembers/messages/' . $booking->id; ?>" style="border:none;"><span class="fa fa-comment"></span> Discuss</a>
                        </div>
                    </div>
                </div>
            </form>
