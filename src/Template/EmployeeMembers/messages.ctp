        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3">
                <div class="bg-white pd_lr_20 box_shadow" style="min-height: 500px; position: relative; padding-bottom: 20px;">
                    ...
                    <div id="user_list_height" class="pd_top_20 custom_scroll sb-container">
                        <?php
                        foreach ($customerDiscussion as $customer) {

                            $path = '';
                            $loginWithSocial = $customer->customer->loginwithsocial;

                            $path = $customer->customer->profile_image;
                            ...
                            ?>
                            <a href="<?php echo $this->request->webroot; ?>EmployeeMembers/messages/<?php echo $customer->id; ?>">
                                <div data-booking="<?php echo $customer->id; ?>" class="row load_messages">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 font_12 pd_0">
                                        <strong><?php echo $customer->customer->full_name; ?></strong><br>
            ...
            <div class="col-md-8 col-lg-9 col-xl-9">
                <div class="bg-white" style="min-height: 500px; position: relative;">
                    ...
                    if (isset($bookingId)) {
                        $path = '';
                        $loginWithSocial = $customerInfo[0]->customer->loginwithsocial;

                        $path = $customerInfo[0]->customer->profile_image;
                        $image = 'cyber1550500683.png';
                        if ($loginWithSocial != 'undefined' && $loginWithSocial != "") {

                            $path = $customerInfo[0]->customer->profile_image;
                        } else if ($loginWithSocial == 'undefined' || $loginWithSocial == '') {
                            if ($customerInfo[0]->customer->profile_image == '') {
                        ...
                        <div class="" style="border-bottom: 1px solid #eaeaea;">
                            <div class="row" id="profile_header">
                                <div class="col-md-10" style="border-right: 1px solid #eaeaea; padding: 7px 30px;">
                                    ...
                                    <div style="display: inline-block; padding-top: 10px;">
                                        <strong>
                                            <?php echo $customerInfo[0]->customer->full_name; ?>
                                ...
                                <div class="col-md-2 text-center" style="padding-top: 15px;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="<?php echo $this->request->webroot . 'EmployeeMembers/employee_events#bookingNumber' . $this->request->params['pass'][0]; ?>">
                                            View Booking Detail
                                        </a>
                                    </div>
                                </div>
                            ...
                            <form method="post" id="chatForm">
                                <div class="row send_msg_row">
                                    <div class="col-md-9 offset-md-1">
                                        ...
                                        <input type="hidden" name="talent_event_id" value="<?php echo $customerInfo[0]->talent_event_id; ?>">
