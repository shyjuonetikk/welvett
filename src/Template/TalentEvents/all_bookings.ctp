...
<div class="container content-container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            echo $this->Form->control('status', ['options' => array('all_disputes' => 'All Disputes', 'pending_disputes' => 'Pending Disputes'), 'empty' => 'All Bookings', 'label' => 'Bookings Satus', 'value' => $val, 'class' => 'form-control']);
            ?>
        </div>
        <div class="col-md-3">
