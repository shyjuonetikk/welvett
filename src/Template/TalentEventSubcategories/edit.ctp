...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $talentEventSubcategory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $talentEventSubcategory->id)]
            )
        ?></li>
...
<div class="talentEventSubcategories form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Talent Event Subcategory') ?></legend>
        <?php
