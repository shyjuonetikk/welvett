...
<?php if (isset($content->role_id)) { ?>
    ...
    <p>
        <?php echo ucwords($customer['first_name'] . ' ' . $customer['last_name']); ?> have dispute with <?php echo ucwords($talent['first_name'] . ' ' . $talent['last_name']); ?> the reason is given bellow:<br/>
        <br/>
        "<?php echo $dispute_reason; ?>"
        <br/><br/>
        Thanks!
